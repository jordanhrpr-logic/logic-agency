export default function sitemap() {
  ...
  return [
    ...
    { url: `${baseUrl}/guides/co-manufacturer-selection`, lastModified: new Date('2026-09-24') },
    { url: `${baseUrl}/guides/cpg-demand-forecasting`, lastModified: new Date('2026-09-24') },
    { url: `${baseUrl}/guides/cpg-gross-margin-playbook`, lastModified: new Date('2026-09-24') },
    { url: `${baseUrl}/guides/cpg-broker-selection-playbook`, lastModified: new Date('2026-09-24') },
    { url: `${baseUrl}/guides/co-manufacturer-contracts-risk`, lastModified: new Date('2026-09-24') },
    { url: `${baseUrl}/guides/regional-to-national-retail-expansion`, lastModified: new Date('2026-09-24') },
    { url: `${baseUrl}/guides/distributor-onboarding-playbook`, lastModified: new Date('2026-09-24') },
