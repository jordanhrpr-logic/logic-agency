...
const posts = [
  ...
  { href: '/blog/outgrowing-first-manufacturer', img: '/images/audio-enhancement.jpg', alt: 'Manufacturer capacity planning for consumer brands', tag: 'Manufacturing', time: '10 min read', title: 'The Hidden Cost of Outgrowing Your First Manufacturer', desc: 'The first factory that helps launch a product may become the constraint that limits quality, capacity, and growth at the next stage.' },
