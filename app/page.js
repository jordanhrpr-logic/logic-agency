    ...
    <>
      ...
      <section className="hero gl">
        <div className="hi">
          ...
          <a href="https://drive.google.com/file/d/1v78gxZkoNjz4sk5bO-MCFMx6sob5jROp/view" className="hero-dl" target="_blank" rel="noopener noreferrer">Or download the free 40-Point Readiness Scorecard &rarr;</a>
          <div className="trust">
